az.hold_value.default_costs = [200, 600, 300, 100, 100, 100];
...
az.hold_value.hold_open_value = az.hold_value.default_costs[3];
az.hold_value.hold_mousebite_value = az.hold_value.default_costs[4];
az.hold_value.hold_pinhole_value = az.hold_value.default_costs[5];
...
function pop_settings() {
  ...
  az.add_checkbox('settings_layout_cells', 5, {
    ...
    function: function (elem, index) {
      ...
      if (typeof az.hold_value.hold_spur_value !== 'undefined') {
        az.set_slider_value(
          'settings_sliders',
          1,
          az.hold_value.hold_spur_value
        );
        az.set_slider_value(
          'settings_sliders',
          2,
          az.hold_value.hold_spurious_value
        );
        az.set_slider_value(
          'settings_sliders',
          3,
          az.hold_value.hold_short_value
        );
        az.set_slider_value(
          'settings_sliders',
          4,
          az.hold_value.hold_open_value
        );
        az.set_slider_value(
          'settings_sliders',
          5,
          az.hold_value.hold_mousebite_value
        );
        az.set_slider_value(
          'settings_sliders',
          6,
          az.hold_value.hold_pinhole_value
        );
      }
  ...
  az.all_add_event('settings_sliders', {
    type: 'as_change',
    function: function () {
      az.hold_value.hold_spur_value = Number(
        az.grab_value('settings_sliders', 1)
      );
      az.hold_value.hold_spurious_value = Number(
        az.grab_value('settings_sliders', 2)
      );
      az.hold_value.hold_short_value = Number(
        az.grab_value('settings_sliders', 3)
      );
      az.hold_value.hold_open_value = Number(
        az.grab_value('settings_sliders', 4)
      );
      az.hold_value.hold_mousebite_value = Number(
        az.grab_value('settings_sliders', 5)
      );
      az.hold_value.hold_pinhole_value = Number(
        az.grab_value('settings_sliders', 6)
      );
    },
  });
}
